// add event listener to each betting button
// event listener will set the value of our bet input to red/black/green depending on which input was used.
// we can add a hidden attribute to the bet input so it doesn't show up in the dom
